...
// Example:
//
//	builder := urlbuilder.New("https://api.github.com")
...
// Example:
//
//	base := urlbuilder.New("https://api.example.com").Path("v1")
...
// Example:
//
//	callbackURL := urlbuilder.App(config.AppURL).Path("api", "webhooks", "callback").String()
...
// Example:
//
//	url := urlbuilder.Webhook(appURL, "github", siteID)
...
// Example:
//
//	url := urlbuilder.TaskCallback(appURL, taskID)
...
// Example:
//
//	url := urlbuilder.API(appURL, "servers", serverID, "status")
