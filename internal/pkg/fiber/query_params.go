...
func ParseIntParam(c *gofiber.Ctx, cfg IntParamConfig) int {
...
func ParseLimit(c *gofiber.Ctx, defaultVal, maxVal int) int {
...
func ParseTail(c *gofiber.Ctx) int {
	return ParseIntParam(c, IntParamConfig{
		Name:    "tail",
		Default: 100,
		Min:     1,
...
func ParseInterval(c *gofiber.Ctx, defaultVal int) int {
	return ParseIntParam(c, IntParamConfig{
		Name:    "interval",
		Default: defaultVal,
		Min:     1,
...
func ParsePage(c *gofiber.Ctx) int {
	return ParseIntParam(c, IntParamConfig{
		Name:    "page",
		Default: 1,
		Min:     1,
...
func ParsePerPage(c *gofiber.Ctx) int {
	return ParseIntParam(c, IntParamConfig{
		Name:    "per_page",
		Default: 15,
		Min:     1,
...
func ParseOffset(c *gofiber.Ctx) int {
	return ParseIntParam(c, IntParamConfig{
		Name:    "offset",
		Default: 0,
		Min:     0,
...
func ParsePagination(c *gofiber.Ctx) PaginationParams {
	page := ParsePage(c)
...
func ParseBool(c *gofiber.Ctx, name string, defaultVal bool) bool {
	str := c.Query(name)
	if str == "" {
		return defaultVal
	}
...
// Returns the default value if the parameter is missing.
func ParseString(c *gofiber.Ctx, name, defaultVal string) string {
	str := c.Query(name)
	if str == "" {
		return defaultVal
	}
