...
func TestLoad_ErrorNonPointer(t *testing.T) {
	...
	if err.Error() != "config.LoadInto: cfg must be a pointer" {
		t.Errorf("LoadInto() error = %v, want 'config.LoadInto: cfg must be a pointer'", err)
	}
}
...
func TestLoad_ErrorNilPointer(t *testing.T) {
	...
	if err.Error() != "config.LoadInto: cfg cannot be nil" {
		t.Errorf("LoadInto() error = %v, want 'config.LoadInto: cfg cannot be nil'", err)
	}
}
...
func TestLoad_ErrorNotStruct(t *testing.T) {
	...
	if err.Error() != "config.LoadInto: cfg must be a pointer to a struct" {
		t.Errorf("LoadInto() error = %v, want 'config.LoadInto: cfg must be a pointer to a struct'", err)
	}
}
