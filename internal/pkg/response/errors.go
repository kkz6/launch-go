...
//
// Usage in handlers:
//   return fiberctx.Abort(apperrors.ErrServerNotFound)
//   return fiberctx.AbortNotFound("Server")
//   return fiberctx.AbortBadRequest("Invalid input")
// =============================================================================
...
//	if err != nil {
//	    return fiberctx.Abort(err)  // Automatically returns 404 for ErrSiteNotFound
//	}
...
// Example: return fiberctx.AbortNotFound("Server")  // "Server not found"
...
// Example: return fiberctx.AbortBadRequest("Invalid server ID")
...
// Example: return fiberctx.AbortForbidden("You don't have permission")
...
// Example: return fiberctx.AbortUnauthorized("Please login")
...
// Example: return fiberctx.AbortConflict("Resource already exists")
...
// Example: return fiberctx.AbortInternal("Something went wrong")
...
// Example: return fiberctx.AbortWithStatus(429, "Too many requests")
...
// Use with service calls: return fiberctx.MustHandle(c, err, data)
