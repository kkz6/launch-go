...
import "github.com/kkz6/launch-go/internal/modules/script/enums"

// CreateScriptRequest represents a request to create a script
type CreateScriptRequest struct {
	Name    string          `json:"name" validate:"required,max=255"`
	RunAs   enums.RunAsUser `json:"run_as" validate:"required,oneof=root local"`
...
type UpdateScriptRequest struct {
	...
	RunAs   *enums.RunAsUser `json:"run_as,omitempty" validate:"omitempty,oneof=root local"`
