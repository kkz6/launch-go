...
func createTestDatabase(t *testing.T, repo *Repository, serverID, name string) *models.Database {
...
func createTestUser(t *testing.T, repo *Repository, serverID, name string) *models.DatabaseUser {
