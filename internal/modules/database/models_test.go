...
func TestInstallationStatus_Values(t *testing.T) {
	assert.Equal(t, InstallationStatus("pending"), StatusPending)
	assert.Equal(t, InstallationStatus("installing"), StatusInstalling)
	assert.Equal(t, InstallationStatus("installed"), StatusInstalled)
	assert.Equal(t, InstallationStatus("failed"), StatusFailed)
	assert.Equal(t, InstallationStatus("uninstalling"), StatusUninstalling)
}
