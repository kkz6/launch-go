...
// =============================================================================
// Kind: which engine the managed service runs (postgres / mysql / redis).
// =============================================================================

// Kind identifies the kind of managed service.
type Kind string
...
func (k Kind) RunTemplateName() string {
	switch k {
	case KindPostgres:
		return "managedservice/run_postgres.sh"
	case KindMySQL:
		return "managedservice/run_mysql.sh"
	case KindRedis:
		return "managedservice/run_redis.sh"
	}
	return ""
}
...
func ParseKind(s string) (Kind, error) {
	k := Kind(s)
	if !k.IsValid() {
		return "", fmt.Errorf("invalid managed service kind: %s", s)
	}
	return k, nil
}
...
// =============================================================================
// Status: the lifecycle state of a managed service row.
// =============================================================================

// Status describes the current lifecycle phase of a managed service.
type Status string
