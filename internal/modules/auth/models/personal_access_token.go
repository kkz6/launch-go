...
type PersonalAccessToken struct {
	...
	TokenableID   string     `gorm:"column:tokenable_id;type:varchar(26);not null;index:personal_access_tokens_tokenable_type_tokenable_id_index,priority:2" json:"tokenable_id"`
