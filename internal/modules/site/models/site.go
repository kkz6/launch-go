...
type Site struct {
	...
	Aliases                      dbtype.JSONStringSlice `gorm:"type:json;serializer:json" json:"aliases,omitempty"`
	...
	Features                     dbtype.JSONStringSlice `gorm:"type:json;serializer:json" json:"features,omitempty"`
	...
	PendingFeatures              dbtype.JSONStringSlice `gorm:"column:pending_features;type:json;serializer:json" json:"pending_features,omitempty"`
	...
	DeployKeyPrivate             dbtype.EncryptedString `gorm:"column:deploy_key_private;type:longtext" json:"-"`
	...
	SharedFiles                  dbtype.JSONStringSlice `gorm:"column:shared_files;type:json;serializer:json" json:"shared_files"`
