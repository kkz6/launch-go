...
func RegisterRoutes(router fiber.Router, handler *Handler, webhookHandler *WebhookHandler, authMiddleware fiber.Handler) {
...
func RegisterSettingsRoutes(settings fiber.Router, handler *Handler) {
