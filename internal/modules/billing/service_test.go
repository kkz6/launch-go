...
func setupTestService(t *testing.T) (*services.BillingService, *repositories.BillingRepository, *gorm.DB) {
...
func TestTeamSubscriptionOptions_MustVerifySubscription(t *testing.T) {
	...
	options := services.NewTeamSubscriptionOptions("team_1", service, enums.UserRoleCustomer, nil, nil, nil)
	assert.True(t, options.MustVerifySubscription())

	service.SetSubscriptionsEnabled(false)
...
func TestTeamSubscriptionOptions_IsAdmin(t *testing.T) {
	...
	customerOptions := services.NewTeamSubscriptionOptions("team_1", service, enums.UserRoleCustomer, nil, nil, nil)
	assert.False(t, customerOptions.IsAdmin())

	managerOptions := services.NewTeamSubscriptionOptions("team_1", service, enums.UserRoleManager, nil, nil, nil)
	assert.True(t, managerOptions.IsAdmin())

	adminOptions := services.NewTeamSubscriptionOptions("team_1", service, enums.UserRoleAdmin, nil, nil, nil)
...
func TestTeamSubscriptionOptions_CanCreateServer(t *testing.T) {
	...
	options := services.NewTeamSubscriptionOptions("team_1", service, enums.UserRoleCustomer, serverCountFn, nil, nil)
	...
	adminOptions := services.NewTeamSubscriptionOptions("team_1", service, enums.UserRoleAdmin, serverCountFn, nil, nil)
...
func TestTeamSubscriptionOptions_CanCreateSiteOnServer(t *testing.T) {
	...
	options := services.NewTeamSubscriptionOptions("team_1", service, enums.UserRoleCustomer, nil, nil, siteCountFn)
...
func TestTeamSubscriptionOptions_CanAddTeamMember(t *testing.T) {
	...
	options := services.NewTeamSubscriptionOptions("team_1", service, enums.UserRoleCustomer, nil, memberCountFn, nil)
...
func TestTeamSubscriptionOptions_PlanOptions_FreeLimits(t *testing.T) {
	...
	assert.Equal(t, services.FreeLimits.MaxServers, planOptions.MaxServers)
	assert.Equal(t, services.FreeLimits.MaxSitesPerServer, planOptions.MaxSitesPerServer)
	assert.Equal(t, services.FreeLimits.HasBackups, planOptions.HasBackups)
}

func TestTeamSubscriptionOptions_PlanOptions_AdminLimits(t *testing.T) {
	service, _, _ := setupTestService(t)

	options := services.NewTeamSubscriptionOptions("team_1", service, enums.UserRoleAdmin, nil, nil, nil)
	planOptions := options.PlanOptions(context.Background())

	assert.Equal(t, services.AdminLimits.MaxServers, planOptions.MaxServers)
	assert.Equal(t, services.AdminLimits.MaxSitesPerServer, planOptions.MaxSitesPerServer)
	assert.Equal(t, services.AdminLimits.HasBackups, planOptions.HasBackups)
}
...
func TestTeamSubscriptionOptions_CountServers(t *testing.T) {
	...
	count, err := (&services.TeamSubscriptionOptions{}).CountServers(context.Background())
	assert.NoError(t, err)
...
func TestTeamSubscriptionOptions_CountSitesOnServer(t *testing.T) {
	...
	count, err := (&services.TeamSubscriptionOptions{}).CountSitesOnServer(context.Background(), "server_1")
	assert.NoError(t, err)
	assert.Equal(t, 0, count)
...
func TestTeamSubscriptionOptions_CountTeamMembers(t *testing.T) {
	...
	count, err := (&services.TeamSubscriptionOptions{}).CountTeamMembers(context.Background())
	assert.NoError(t, err)
...
func TestService_ResumeSubscription_NotCancelled(t *testing.T) {
	...
	assert.ErrorIs(t, err, services.ErrSubscriptionNotCancelled)
}
...
func TestService_ResumeSubscription_GracePeriodEnded(t *testing.T) {
	...
	err := service.ResumeSubscription(context.Background(), sub.ID)
	assert.ErrorIs(t, err, services.ErrCannotResume)
}
