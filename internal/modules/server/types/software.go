...
func GetAllSoftwareGroups() []SoftwareGroup {
	return []SoftwareGroup{
		...
		},
		{
			...
			ImagePath:  "/images/software/docker.svg",
			Software:   []Software{SoftwareDocker},
			HasStart:   true,
			HasStop:    true,
			HasRestart: true,
			HasRemove:  true,
		...
		},
		{
			Group:      "traefik",
			Label:      "Traefik",
			Type:       ServiceTypeTraefik,
			ImagePath:  "/images/software/traefik.svg",
			Software:   []Software{SoftwareTraefik},
			HasStart:   true,
			HasStop:    true,
			HasRestart: true,
			HasRemove:  true,
